...
steps:
  ...
  SDM>removeCollinearity.yml@97:
    ...
    in:
      rasters: summarise_layers>combine_rasters.yml@153/combined_rasters
  ...
  summarise_layers>combine_rasters.yml@153:
    run: ../../tools/summarise_layers/combine_rasters.cwl
    in:
      rasters1: data>loadFromStac.yml@150/rasters
