            ...
            "inputs": [
                {
                    ...
                    "id": "#createCollection.cwl/collection_description"
                },
                {
                    "type": [
                        "null",
                    ...
                    "default": "CC-BY",
                    "id": "#createCollection.cwl/collection_license"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#createCollection.cwl/collection_name"
                },
                {
                    "type": "string",
                    "doc": "Base URL to check for conda-pack environments.",
                    "default": "https://object-arbutus.alliancecan.ca/swift/v1/3857940e33774dca8ae21e4999fe402e/conda-pack/",
                    "id": "#createCollection.cwl/condaPackURL"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "Folder for conda-pack to export environments. This avoids downloading/resolving the same environment multiple times.",
                    "id": "#createCollection.cwl/envFolder"
                },
                {
                    "type": "boolean",
                    "doc": "Whether the envFolder should be writable. If false, the folder will be mounted read-only. In that case, the conda environment needs to be present as an unpacked conda-pack beforehand otherwise the script can't run. envFolderWritable must be false when running in a workflow, but can be true when ran as an individual tool.",
                    "default": true,
                    "id": "#createCollection.cwl/envFolderWritable"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "Optional. BON in a Box runner.env file, necessary for scripts requiring credentials. If not provided, an empty one will be used.",
                    "id": "#createCollection.cwl/environment"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "Optional. This folder will keep the input.json, output.json, logs.txt, and any other file saved by the script. If left blank, a temporary folder will be used and discarded after the run.",
                    "id": "#createCollection.cwl/runFolder"
                },
                {
                    "type": "string",
                    "doc": "Path to the script, relative to scripts root.",
                    "default": "STAC/createCollection.py",
                    "id": "#createCollection.cwl/scriptPath"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "Root folder for scripts. Use this to override the image's scripts while debugging.",
                    "id": "#createCollection.cwl/scripts_root"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#createCollection.cwl/tiff_files"
                }
            ],
            "outputs": [
                {
        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    ...
                    "default": "A STAC collection created from GeoTIFF files.",
                    "id": "#main/STAC>createCollection.yml@153|collection_description"
                },
                {
                    "type": [
                        "null",
                    ...
                    "default": "CC-BY",
                    "id": "#main/STAC>createCollection.yml@153|collection_license"
                },
                {
                    "type": [
                        "null",
                    ...
                    "default": "biab-collection",
                    "id": "#main/STAC>createCollection.yml@153|collection_name"
                },
                {
                    "type": "string",
                    "doc": "Base URL to check for conda-pack environments.",
                ...
                },
                {
                    ...
                    "id": "#main/data>loadFromStac.yml@150|collections_items"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#main/data>loadFromStac.yml@150|stac_url"
                },
                {
                    "type": [
                        "null",
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": [
                                "#main/data>loadFromStac.yml@150/rasters_out",
                ...
                {
                    "run": "#createCollection.cwl",
                    "in": [
                        {
                            "source": "#main/STAC>createCollection.yml@153|collection_description",
                            "id": "#main/STAC>createCollection.yml@153/collection_description"
                        },
                        {
                            "source": "#main/STAC>createCollection.yml@153|collection_license",
                            "id": "#main/STAC>createCollection.yml@153/collection_license"
                        },
                        {
                            "source": "#main/STAC>createCollection.yml@153|collection_name",
                            "id": "#main/STAC>createCollection.yml@153/collection_name"
                        },
                        {
                            "source": "#main/condaPackURL",
                        ...
                        },
                        {
                            ...
                            "id": "#main/STAC>createCollection.yml@153/runFolder"
                        },
                        {
                            "source": "#main/scripts_root",
                            "id": "#main/STAC>createCollection.yml@153/scripts_root"
                        },
                        {
                            "source": [
                                "#main/SDM>runMaxent.yml@108/sdm_pred_out"
                            ...
                            "linkMerge": "merge_flattened",
                            "id": "#main/STAC>createCollection.yml@153/tiff_files"
                        }
                    ],
                    "out": [
                        "#main/STAC>createCollection.yml@153/stac_collection_out"
                    ],
                    "id": "#main/STAC>createCollection.yml@153"
                },
                {
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "default": "first",
                            "id": "#main/data>loadFromStac.yml@150/aggregation"
                        },
                        {
                            "source": "#main/pipeline@140",
                            "id": "#main/data>loadFromStac.yml@150/bbox_crs"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@150|collections_items",
                            "id": "#main/data>loadFromStac.yml@150/collections_items"
                        },
                        {
                            "source": "#main/condaPackURL",
                        ...
                        {
                            "default": "near",
                            "id": "#main/data>loadFromStac.yml@150/resampling"
                        },
                        {
                            "source": "#main/runFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/data__loadFromStac/150' } : null)",
                            "id": "#main/data>loadFromStac.yml@150/runFolder"
                        },
                        {
                            "source": "#main/scripts_root",
                            "id": "#main/data>loadFromStac.yml@150/scripts_root"
                        },
                        {
                            "source": "#main/pipeline@128",
                            "id": "#main/data>loadFromStac.yml@150/spatial_res"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@150|stac_url",
                            "id": "#main/data>loadFromStac.yml@150/stac_url"
                        },
                        {
                            "source": "#main/pipeline@152",
                            "id": "#main/data>loadFromStac.yml@150/study_area"
                        },
                        {
                            "source": "#main/pipeline@148",
                            "id": "#main/data>loadFromStac.yml@150/t0"
                        },
                        {
                            "source": "#main/pipeline@149",
                            "id": "#main/data>loadFromStac.yml@150/t1"
                        },
                        {
                            "source": "#main/pipeline@151",
                            "id": "#main/data>loadFromStac.yml@150/temporal_res"
                        }
                    ],
                    "out": [
                        "#main/data>loadFromStac.yml@150/rasters_out"
                    ],
                    "id": "#main/data>loadFromStac.yml@150"
                },
                {
