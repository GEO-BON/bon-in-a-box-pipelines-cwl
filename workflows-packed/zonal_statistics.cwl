            ...
            "inputs": [
                ...
                },
                {
                    "type": {
                        "type": "enum",
                        "symbols": [
                            "#main/data>loadFromStac.yml@25|aggregation/first",
                            "#main/data>loadFromStac.yml@25|aggregation/min",
                            "#main/data>loadFromStac.yml@25|aggregation/max",
                            "#main/data>loadFromStac.yml@25|aggregation/mean",
                            "#main/data>loadFromStac.yml@25|aggregation/median"
                        ]
                    },
                    "label": "Aggregation method",
                    "doc": "Method used to aggregate items when layers combining over time.\nWill be ignored if not combining over time.\n",
                    "default": "first",
                    "id": "#main/data>loadFromStac.yml@25|aggregation"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#main/data>loadFromStac.yml@25|collections_items"
                },
                {
                    "type": {
                        "type": "enum",
                        "symbols": [
                            "#main/data>loadFromStac.yml@25|resampling/near",
                            "#main/data>loadFromStac.yml@25|resampling/bilinear",
                            "#main/data>loadFromStac.yml@25|resampling/average",
                            "#main/data>loadFromStac.yml@25|resampling/mode",
                            "#main/data>loadFromStac.yml@25|resampling/cubic",
                            "#main/data>loadFromStac.yml@25|resampling/cubicspline",
                            "#main/data>loadFromStac.yml@25|resampling/lanczos",
                            "#main/data>loadFromStac.yml@25|resampling/rms",
                            "#main/data>loadFromStac.yml@25|resampling/min",
                            "#main/data>loadFromStac.yml@25|resampling/max",
                            "#main/data>loadFromStac.yml@25|resampling/sum",
                            "#main/data>loadFromStac.yml@25|resampling/med",
                            "#main/data>loadFromStac.yml@25|resampling/q1",
                            "#main/data>loadFromStac.yml@25|resampling/q3"
                        ]
                    },
                    "label": "Resampling method",
                    ...
                    "default": "near",
                    "id": "#main/data>loadFromStac.yml@25|resampling"
                },
                {
                    "type": [
                        "null",
                    ...
                    "default": 1000,
                    "id": "#main/data>loadFromStac.yml@25|spatial_res"
                },
                {
                    "type": [
                        "null",
                    ...
                    "doc": "URL of the STAC catalog.",
                    "default": "https://stac.geobon.org/",
                    "id": "#main/data>loadFromStac.yml@25|stac_url"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#main/data>loadFromStac.yml@25|t0"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#main/data>loadFromStac.yml@25|t1"
                },
                {
                    "type": [
                        "null",
                    ...
                    "id": "#main/data>loadFromStac.yml@25|temporal_res"
                },
                {
                    "type": {
                        "type": "enum",
                        "symbols": [
                            "#main/data>load_polygons.yml@28|polygon_type/Country or region",
                            "#main/data>load_polygons.yml@28|polygon_type/WDPA",
                            "#main/data>load_polygons.yml@28|polygon_type/EEZ"
                        ]
                    },
                    "label": "Polygon type",
                    "doc": "Type of polygon to load. Country or region polygons, World database of Protected Areas (WDPA), Exclusive Economic Zones (EEZs), or a custom polygon of a bounding box.",
                    "default": "Country or region",
                    "id": "#main/data>load_polygons.yml@28|polygon_type"
                },
                {
                    "type": [
                        "null",
                ...
                },
                {
                    ...
                    "type": {
                        "type": "record",
                        "name": "#main/pipeline@27/bboxCRS",
                        "fields": [
                            {
                                "name": "#main/pipeline@27/bboxCRS/country",
                                "type": {
                                    "name": "#main/pipeline@27/bboxCRS/country/countryDefinition",
                                    "type": "record",
                                    "fields": [
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/country/countryDefinition/englishName",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/country/countryDefinition/ISO3",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/country/countryDefinition/bboxWGS84",
                                            "type": [
                                                "null",
                                                {
                                                    "type": "array",
                            ...
                            {
                                "name": "#main/pipeline@27/bboxCRS/CRS",
                                "type": {
                                    "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition",
                                    "type": "record",
                                    "fields": [
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/unit",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/code",
                                            "type": [
                                                "null",
                                                "int"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/authority",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/name",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/CRSBboxWGS84",
                                            "type": [
                                                "null",
                                                {
                                                    "type": "array",
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/proj4Def",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/CRS/CRSDefinition/wktDef",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                            ...
                            {
                                "name": "#main/pipeline@27/bboxCRS/bbox",
                                "type": {
                                    "type": "array",
                                    "items": "float"
                                }
                            ...
                            {
                                "name": "#main/pipeline@27/bboxCRS/region",
                                "type": {
                                    "name": "#main/pipeline@27/bboxCRS/region/regionDefinition",
                                    "type": "record",
                                    "fields": [
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/region/regionDefinition/countryEnglishName",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/region/regionDefinition/regionID",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/region/regionDefinition/regionName",
                                            "type": [
                                                "null",
                                                "string"
                                            ]
                                        ...
                                        {
                                            "name": "#main/pipeline@27/bboxCRS/region/regionDefinition/bboxWGS84",
                                            "type": [
                                                "null",
                                                {
                                                    "type": "array",
                ...
                },
                {
                    "type": {
                        ...
                        "items": {
                            "type": "enum",
                            "symbols": [
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/mean",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/median",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/sum",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/min",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/max",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/stdev",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/variance",
                                "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic/mode"
                            ]
                        }
                    },
                    "label": "Summary statistic",
                    ...
                    "id": "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic"
                }
            ],
            "steps": [
                {
                    ...
                    "in": [
                        {
                            "source": "#main/data>loadFromStac.yml@25|aggregation",
                            "id": "#main/data>loadFromStac.yml@25/aggregation"
                        },
                        {
                            "source": "#main/pipeline@27",
                            "id": "#main/data>loadFromStac.yml@25/bbox_crs"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|collections_items",
                            "id": "#main/data>loadFromStac.yml@25/collections_items"
                        },
                        {
                            "source": "#main/condaPackURL",
                            "id": "#main/data>loadFromStac.yml@25/condaPackURL"
                        },
                        {
                            "source": "#main/prepareEnvironments/envFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/data__loadFromStac' } : null)",
                            "id": "#main/data>loadFromStac.yml@25/envFolder"
                        },
                        {
                            "default": false,
                            "id": "#main/data>loadFromStac.yml@25/envFolderWritable"
                        },
                        {
                            "source": "#main/environment",
                            "id": "#main/data>loadFromStac.yml@25/environment"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|resampling",
                            "id": "#main/data>loadFromStac.yml@25/resampling"
                        },
                        {
                            "source": "#main/runFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/data__loadFromStac/25' } : null)",
                            "id": "#main/data>loadFromStac.yml@25/runFolder"
                        },
                        {
                            "source": "#main/scripts_root",
                            "id": "#main/data>loadFromStac.yml@25/scripts_root"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|spatial_res",
                            "id": "#main/data>loadFromStac.yml@25/spatial_res"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|stac_url",
                            "id": "#main/data>loadFromStac.yml@25/stac_url"
                        },
                        {
                            "source": "#main/data>load_polygons.yml@28/polygon_out",
                            "id": "#main/data>loadFromStac.yml@25/study_area"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|t0",
                            "id": "#main/data>loadFromStac.yml@25/t0"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|t1",
                            "id": "#main/data>loadFromStac.yml@25/t1"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25|temporal_res",
                            "id": "#main/data>loadFromStac.yml@25/temporal_res"
                        }
                    ],
                    "out": [
                        "#main/data>loadFromStac.yml@25/rasters_out"
                    ],
                    "id": "#main/data>loadFromStac.yml@25"
                },
                {
                    ...
                    "in": [
                        {
                            "default": 0.0,
                            "id": "#main/data>load_polygons.yml@28/buffer"
                        },
                        {
                            "source": "#main/condaPackURL",
                            "id": "#main/data>load_polygons.yml@28/condaPackURL"
                        },
                        {
                            "source": "#main/pipeline@27",
                            "id": "#main/data>load_polygons.yml@28/country_region_bbox"
                        },
                        {
                            "source": "#main/prepareEnvironments/envFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/data__load_polygons' } : null)",
                            "id": "#main/data>load_polygons.yml@28/envFolder"
                        },
                        {
                            "default": false,
                            "id": "#main/data>load_polygons.yml@28/envFolderWritable"
                        },
                        {
                            "source": "#main/environment",
                            "id": "#main/data>load_polygons.yml@28/environment"
                        },
                        {
                            "source": "#main/data>load_polygons.yml@28|polygon_type",
                            "id": "#main/data>load_polygons.yml@28/polygon_type"
                        },
                        {
                            "source": "#main/runFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/data__load_polygons/28' } : null)",
                            "id": "#main/data>load_polygons.yml@28/runFolder"
                        },
                        {
                            "source": "#main/scripts_root",
                            "id": "#main/data>load_polygons.yml@28/scripts_root"
                        }
                    ],
                    "out": [
                        "#main/data>load_polygons.yml@28/polygon_out",
                        "#main/data>load_polygons.yml@28/bbox_crs_out"
                    ],
                    "id": "#main/data>load_polygons.yml@28"
                },
                {
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "source": "#main/pipeline@27",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/bbox_crs"
                        },
                        {
                            "source": "#main/condaPackURL",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/condaPackURL"
                        },
                        {
                            "source": "#main/prepareEnvironments/envFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/zonal_statistics__zonal_stats' } : null)",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/envFolder"
                        },
                        {
                            "default": false,
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/envFolderWritable"
                        },
                        {
                            "source": "#main/environment",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/environment"
                        },
                        {
                            "source": "#main/data>loadFromStac.yml@25/rasters_out",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/rasters"
                        },
                        {
                            "source": "#main/runFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/zonal_statistics__zonal_stats/4' } : null)",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/runFolder"
                        },
                        {
                            "source": "#main/scripts_root",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/scripts_root"
                        },
                        {
                            "source": "#main/data>load_polygons.yml@28/polygon_out",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/study_area_polygon"
                        },
                        {
                            "source": "#main/zonal_statistics>zonal_stats.yml@4|summary_statistic",
                            "id": "#main/zonal_statistics>zonal_stats.yml@4/summary_statistic"
                        }
                    ],
                    "out": [
                        "#main/zonal_statistics>zonal_stats.yml@4/zonal_stats_out"
                    ],
                    "id": "#main/zonal_statistics>zonal_stats.yml@4"
                }
            ],
            "outputs": [
                {
                    ...
                    "label": "Rasters",
                    "doc": "Output raster files in geotiff format.",
                    "outputSource": "#main/data>loadFromStac.yml@25/rasters_out",
                    "id": "#main/data>loadFromStac.yml@25|rasters_out"
                },
                {
                    "type": "File",
                    "label": "Summary statistic",
                    "doc": "Summary statistic over the polygon",
                    "outputSource": "#main/zonal_statistics>zonal_stats.yml@4/zonal_stats_out",
                    "id": "#main/zonal_statistics>zonal_stats.yml@4|zonal_stats_out"
                }
            ],
            "id": "#main"
        }
