        ...
        },
        {
            ...
            "inputs": [
                ...
                },
                {
                    "type": {
                        "type": "enum",
                        "symbols": [
                            "#main/data>load_polygons.yml@24|polygon_type/Country or region",
                            "#main/data>load_polygons.yml@24|polygon_type/Polygon of bounding box"
                        ]
                    },
                    "label": "Polygon type",
                    "doc": "Type of polygon to load. Country or region polygons, World database of Protected Areas (WDPA), Exclusive Economic Zones (EEZs), or a custom polygon of a bounding box.",
                    "default": "Country or region",
                    "id": "#main/data>load_polygons.yml@24|polygon_type"
                },
                {
                    "type": [
                        "null",
            ...
            "steps": [
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/data>load_polygons.yml@24/polygon_out",
                ...
                },
                {
                    ...
                    "in": [
                        {
                            "default": 0.0,
                            "id": "#main/data>load_polygons.yml@24/buffer"
                        },
                        {
                            "source": "#main/condaPackURL",
                            "id": "#main/data>load_polygons.yml@24/condaPackURL"
                        },
                        {
                            "source": "#main/pipeline@23",
                        ...
                        {
                            "source": "#main/data>load_polygons.yml@24|polygon_type",
                            "id": "#main/data>load_polygons.yml@24/polygon_type"
                        },
                        {
                            "source": "#main/runFolder",
                            "valueFrom": "$(self ? { class: 'Directory', location: self.location + '/data__load_polygons/24' } : null)",
                            "id": "#main/data>load_polygons.yml@24/runFolder"
                        },
                        {
                            "source": "#main/scripts_root",
                            "id": "#main/data>load_polygons.yml@24/scripts_root"
                        }
                    ],
                    "out": [
                        "#main/data>load_polygons.yml@24/polygon_out",
                        "#main/data>load_polygons.yml@24/bbox_crs_out"
                    ],
                    "id": "#main/data>load_polygons.yml@24"
                },
                {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "label": "Polygon",
                    "doc": "Polygons of the country, WDPA, EEZs for the country or region of interest",
                    "outputSource": "#main/data>load_polygons.yml@24/polygon_out",
                    "id": "#main/data>load_polygons.yml@24|polygon_out"
                }
            ],
            "id": "#main"
        }
