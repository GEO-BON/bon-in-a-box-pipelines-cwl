...
doc:
  - |
    Description:
    Sample shell script that outputs a number.
...
arguments:
  - |
    ...
    bash \
      $SCRIPT_STUBS_LOCATION/system/scriptWrapper.sh \
      $OUTPUT_LOCATION \
...
inputs:
  ...
  scriptPath:
    ...
    default: helloWorld/helloShell.sh
...
outputs:
  a_number_out:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "a_number");
