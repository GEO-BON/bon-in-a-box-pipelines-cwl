...
arguments:
  - |
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "site_selection_BAS__BAS_algorithm" \
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh site_selection_BAS__BAS_algorithm /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  rast_blocks:
    ...
    default: rast_blocks.tif

  ndesign:
    type: int?
    label: Target total sites
    doc: A number of target sites to obtain
    default: 100
  ...
  options_bas:
    type:
      ...
      symbols:
        ...
        - unequal
    label: Sampling type
    doc: Select and option beween equal BAS or unequal prob BAS
    default: equal
  ...
  scriptPath:
    ...
    default: site_selection_BAS/script_BAS_algorithm.R
...
outputs:
  maps_output:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "maps_output");
  ...
  pts_df:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "pts_df");
          return value;
        }
  ...
  points_shape:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "points_shape");
          if (value === null) return null;
          return { class: "File", location: "file://" + value };
        }
