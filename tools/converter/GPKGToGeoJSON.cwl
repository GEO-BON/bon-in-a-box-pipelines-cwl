...
label: GeoPackage to GeoJSON
doc:
  - |
    Description:
    This script converts a GeoPackage file to GeoJSON file.
  - |
    Authors:
  ...
  - |
    ...
    ${
      return JSON.stringify({
        gpkg_file: inputs.gpkg_file ? inputs.gpkg_file.path : null,
      }, null, 2);
    }
    JSON
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "converter__GPKGToGeoJSON" \
    "channels: [conda-forge]
    dependencies: [geopandas]
    name: converter__GPKGToGeoJSON
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh converter__GPKGToGeoJSON /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  scriptPath:
    ...
    default: converter/geoJSONToGPKG.py
...
outputs:
  geojson_file:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "geojson_file");
