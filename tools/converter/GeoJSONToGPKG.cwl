...
label: GeoJSON to GeoPackage
doc:
  - |
    Description:
    This script converts a GeoJSON file to GeoPackage file.
  - |
    Authors:
  ...
  - |
    ...
    ${
      return JSON.stringify({
        geojson_file: inputs.geojson_file ? inputs.geojson_file.path : null,
      }, null, 2);
    }
    JSON
...
outputs:
  gpkg_file:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "gpkg_file");
