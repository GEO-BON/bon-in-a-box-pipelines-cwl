...
label: IUCN list of species of a country
doc:
  - "Description:
    Obtains a list of species assessed by the IUCN Red List of Species for a specific country, including their most recent threat categorization."
  - "Authors:
...
arguments:
  - |
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "IUCNRedlistIndex__IUCN_redlist_spCountry" \
      "
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh IUCNRedlistIndex__IUCN_redlist_spCountry /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  scriptPath:
    ...
    default: IUCNRedlistIndex/IUCN_redlist_spCountry.R
...
outputs:
  iucn_country_splist:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "iucn_country_splist");
