...
label: IUCN list of species from a use or trade
doc:
  - |
    Description:
    Obtains a list of species assessed by the IUCN Red List of Species for a specific use or trade, including their most recent threat categorization.
  - |
    Authors:
...
arguments:
  - |
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "IUCNRedlistIndex__IUCN_redlist_spUse" \
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh IUCNRedlistIndex__IUCN_redlist_spUse /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  scriptPath:
    ...
    default: IUCNRedlistIndex/IUCN_redlist_spUse.R
...
outputs:
  iucn_use_splist_out:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "iucn_use_splist");
  ...
  species_use_out:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "species_use");
          if (value === null) return null;
