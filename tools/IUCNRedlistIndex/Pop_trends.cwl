...
arguments:
  - |
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "IUCNRedlistIndex__Pop_trends" \
    "channels: [conda-forge, r]
    dependencies: [r-rredlist, r-rjson, r-dplyr, r-magrittr]
    name: IUCNRedlistIndex__Pop_trends
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh IUCNRedlistIndex__Pop_trends /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  splist:
    type: File?
    label: Species list
    doc: Dataset with the list of species from which to calculate the percentage of different population trends.
    default: /scripts/IUCNRedlistIndex/species_list.csv
  ...
  scriptPath:
    ...
    default: IUCNRedlistIndex/Pop_trends.R
...
outputs:
  population_trend_percent:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "population_trend_percent");
