...
label: IUCN list of species of a threat category
doc:
  - "Description:
    Obtains a list of species assessed by the IUCN Red List of Species that are threatened by a threat type"
  - "Authors:
  ...
  - |
    ...
    ${
      return JSON.stringify({
        threat_category_input: inputs.threat_category_input,
      }, null, 2);
    }
    JSON
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "IUCNRedlistIndex__IUCN_redlist_spThreats" \
      "
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh IUCNRedlistIndex__IUCN_redlist_spThreats /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  scriptPath:
    ...
    default: IUCNRedlistIndex/IUCN_redlist_spThreats.R
...
outputs:
  threat_category:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "threat_category");
  ...
  threats_list:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "threats_list");
          if (value === null) return null;
  ...
  iucn_threats_splist:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "iucn_threats_splist");
          if (value === null) return null;
          return { class: "File", location: "file://" + value };
        }
