...
label: Shapefile from Google Drive
doc:
  - "Description:
    This script imports files within a .zip folder stored in Google Drive."
  - "Lifecycle tag: Core."
  - "Authors:
    Sarah Valentin (https://orcid.org/0000-0002-9028-681X)"
  - "External link: https://googledrive.tidyverse.org/"
...
inputs:
  ...
  url:
    type: string?
    label: link
    doc: String, link to the file.
    default: https://drive.google.com/file/d/1KKFOBKInnroe452Y7P8uu-h42QbHM6ff/view?usp=sharing

  shp_name:
    type: string?
    label: shapefile name
    doc: String, name of the shapefile.
    default: shape_study_area_nolakes_nad83
...
outputs:
  extent:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "extent");
