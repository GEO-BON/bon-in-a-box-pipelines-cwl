...
inputs:
  ...
  presence_background:
    ...
    doc: Path to the background point
    default: /output/setupDataSdm/setupDataSdm_R/595d3ffe701bddcc27bd732ed5a9a6fa/presence_background.tsv

  predictors:
    type: File[]
    label: predictors
    doc: layer names (predictors) as a list, or path to a list
    default: /output/setupDataSdm/setupDataSdm_R/595d3ffe701bddcc27bd732ed5a9a6fa/predictors.tif

  quantile_min:
    type: float
    label: quantile min
    doc: lower bound for credible interval calculation
    default: 0.025

  quantile_max:
    type: float
    label: quantile max
    doc: upper bound for credible interval calculation
    default: 0.095
