...
label: Get country polygon
doc:
  - |
    Description:
    This script pulls country (or state/province/region) polygons using the [GeoBoundaries API](https://www.geoboundaries.org/),
    and outputs as a geopackage, projected in the crs of interest. If the user inputs a custom bounding box, the script will return a polygon made from the bounding box using the sf package.
  - |
...
arguments:
  - |
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "data__getCountryPolygon" \
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh data__getCountryPolygon /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  bbox_crs:
    ...
    doc: Select a country and/or region, or type in/draw a custom bounding box. Then, choose an appropriate CRS.
    type:
      type: record
      name: bboxCRS
      fields:
  ...
  scriptPath:
    ...
    default: data/getCountryPolygon.R
...
outputs:
  country:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "country");
          return value;
        }
  ...
  region:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "region");
          return value;
        }
  ...
  country_region_polygon:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "country_region_polygon");
