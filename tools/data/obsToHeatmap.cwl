...
label: Observations to Heatmap
doc:
  - |
    Description:
    Converts occurrence points to raster, conforming to resolution and projection of the predictors raster.
  - "Lifecycle tag: Core."
  - |
    Authors:
    Dat Nguyen
  ...
  - |
    ...
    ${
      return JSON.stringify({
        ...
        predictors: inputs.predictors ? inputs.predictors.path : null,
      }, null, 2);
    }
    JSON
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "data__obsToHeatmap" \
    "channels: [conda-forge, r]
    dependencies: [r-terra, r-rjson, r-raster, r-stars]
    name: data__obsToHeatmap
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh data__obsToHeatmap /conda-envs >> "$log" 2>&1
...
outputs:
  heatmap:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "heatmap");
