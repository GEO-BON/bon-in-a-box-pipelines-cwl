...
label: Get protected areas from World Database on Protected Areas (WDPA)
doc:
  - "Description:
    This script finds and saves the polygons of protected areas of a given country from the world database of protected areas (WDPA)."
  - "Lifecycle tag: Deprecated. This script is deprecated. Please use the "Load Polygons" script instead."
  - "Authors:
    Guillaume Larocque (guillaume.larocque@mcgill.ca, https://orcid.org/0000-0002-5967-9156)"
  - "References:
    UNEP-WCMC and IUCN (2024), Protected Planet. The World Database on Protected Areas (WDPA)[On-line], [October 2024], Cambridge, UK. UNEP-WCMC and IUCN. Available at null"
...
arguments:
  - |
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaEnvironment.sh $OUTPUT_LOCATION "data__getWDPA" \
      "
        channels: [conda-forge]
        dependencies: [pandas, geopandas, pyproj, requests]
        name: data__getWDPA
    ...
    source $SCRIPT_STUBS_LOCATION/system/condaPackEnvironment.sh data__getWDPA /conda-envs >> "$log" 2>&1
...
inputs:
  ...
  country:
    ...
    doc: Object containing country ISO3 code.
    type:
      type: record
      name: bboxCRS
      fields:
...
outputs:
  protected_area_polygon:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "protected_area_polygon");
  ...
  country_bounding_box:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "country_bounding_box");
          if (value === null) return null;
          return { class: "File", location: "file://" + value };
        }
