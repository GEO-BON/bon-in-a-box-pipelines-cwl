...
label: Helper script for STAC Catalogue
doc:
  - "Description:
    This script takes two dates as input and returns the names of the STAC Catalogue items in the ESA Landcover collection for those dates."
  - "Authors:
...
inputs:
  ...
  start_year:
    type: int
    label: Start year
    doc: Year of the first STAC Catalogue item wanted
    default: 2010

  end_year:
    type: int
    label: End year
    doc: Year of the second STAC Catalogue item wanted
    default: 2011
  ...
  scriptPath:
    ...
    default: data/helperForCatalogue.R
...
outputs:
  collections:
    ...
    outputBinding:
      ...
      outputEval: |
        ${
          var value = extractOutput(self, "collections");
